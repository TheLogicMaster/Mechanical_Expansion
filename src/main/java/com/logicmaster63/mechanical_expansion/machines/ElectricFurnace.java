...
public class ElectricFurnace extends AbstractSingleBlock {
    ...
    public void breakBlock(World world, BlockPos pos, IBlockState blockstate) {
        ElectricFurnaceTileEntity te = (ElectricFurnaceTileEntity) world.getTileEntity(pos);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ElectricFurnaceTileEntity te = (ElectricFurnaceTileEntity)worldIn.getTileEntity(pos);
